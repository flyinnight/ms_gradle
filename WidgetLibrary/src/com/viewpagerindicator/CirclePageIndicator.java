...
public class CirclePageIndicator extends View implements PageIndicator {
	...
	public CirclePageIndicator(Context context, AttributeSet attrs, int defStyle) {
		...
		final int defaultPageColor = Color.parseColor("#FFFFFFFF");// res.getColor(R.color.default_circle_indicator_page_color);
		final int defaultFillColor = Color.parseColor("#00000000");// res.getColor(R.color.default_circle_indicator_fill_color);
		...
		final float defaultStrokeWidth = dip2px(context, 1);// res.getDimension(R.dimen.default_circle_indicator_stroke_width);
		final float defaultRadius = dip2px(context, 3);// res.getDimension(R.dimen.default_circle_indicator_radius);
		...
		mRadius = a.getDimension(R.styleable.CirclePageIndicator_radius,
				defaultRadius);
		mDistance = a.getDimension(R.styleable.CirclePageIndicator_distance, mRadius * 3);
	...
	public void setViewPager(ViewPager view) {
        ...
        try {
        	...
        	Object obj = field.get(mViewPager);
        	if(obj != null && obj instanceof OnPageChangeListener) {
