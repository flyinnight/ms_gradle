...
public class ActivityTabsPager extends BaseFragmentActivity {
	TabHost mTabHost;
...
//							indicatorViews[i]), FragmentSkinTestOld.class, null);
	...
	private View[] getIndicatorViews() {
		...
		int[] iconRes = new int[] { R.drawable.btn_topic, R.drawable.btn_test,
				R.drawable.btn_found, R.drawable.btn_mine };
		int[] textRes = new int[] { R.string.main_test, R.string.main_topic,
				R.string.main_found, R.string.main_mine };
		View[] indicators = new View[tabLength];

		LayoutInflater inflater = LayoutInflater.from(this);

		for (int i = 0; i < indicators.length; i++) {
			View indicator = inflater.inflate(R.layout.layout_tabs_indicator,
					null);
