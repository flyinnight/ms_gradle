 ...
 */
public class FragmentTopicNew extends BaseFragment implements View.OnClickListener {
...
//                startActivity(intent);
    ...
    private void requestMyFocusedTopics() {
        ...
        MMyTopicReq req =  new MMyTopicReq();
        req.setPageNo(1);
        ...
        addCallback(node);
        mt.getMyFollowTopicByTypeAsync(req, node, GetPostList.GET_DATA_SERVER);
    }
