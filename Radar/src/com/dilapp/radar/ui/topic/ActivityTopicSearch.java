...
public class ActivityTopicSearch extends BaseActivity implements
    ...
    public class TasteHistory extends RecyclerView.Adapter<ViewHolder>
            ...
            registerAdapterDataObserver(new AdapterDataObserver() {
                ...
                public void onItemRangeRemoved(int positionStart, int itemCount) {
                    for (int i = positionStart; i < positionStart + itemCount; i++) {
                        ActivityTopicSearch.this.onRemoveTasteHistory(i);
                        if (getItemCount() == 1) {
        ...
        public void onClick(View v) {
            ...
            if (BuildConfig.DEBUG) {
                ActivityTopicSearch.this.onClick(btn_cancel);
            }
        }
    }
