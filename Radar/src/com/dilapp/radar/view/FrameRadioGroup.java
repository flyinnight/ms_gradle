...
public class FrameRadioGroup extends FrameLayout {
     ...
     * {@inheritDoc}
     */
    public FrameRadioGroup(Context context) {
        super(context);
        init();
    }
     ...
     * {@inheritDoc}
     */
    public FrameRadioGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new FrameRadioGroup.LayoutParams(getContext(), attrs);
    }
    ...
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof FrameRadioGroup.LayoutParams;
    }
     ...
     * <p/>
     * <p>
     * See {@link android.R.styleable#FrameLayout_Layout LinearLayout
    ...
    public interface OnCheckedChangeListener {
         ...
         */
        public void onCheckedChanged(FrameRadioGroup group, int checkedId);
    }
    ...
    private class PassThroughHierarchyChangeListener implements
        ...
        public void onChildViewAdded(View parent, View child) {
            if (parent == FrameRadioGroup.this
                ...
                try {
                    Method method = CompoundButton.class.getDeclaredMethod(
            ...
            if (parent == FrameRadioGroup.this
                ...
                try {
                    Method method = CompoundButton.class.getDeclaredMethod(
                            ...
                            CompoundButton.OnCheckedChangeListener.class);
                    method.setAccessible(true);
                    // 为了迁就Android Studio的编译系统，不得不这样写。
                    // 否则每 run 一次，这个文件就弹出来，好烦！
                    CompoundButton.OnCheckedChangeListener empty = null;
                    method.invoke(child, empty);
                } catch (Exception e) {
                    e.printStackTrace();
                }
