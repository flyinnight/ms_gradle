 ...
 */
@SuppressLint("NewApi")
public class RadarRefreshLayout extends ViewGroup {
	// Maps to ProgressBar.Large style
	public static final int LARGE = MaterialProgressDrawable.LARGE;
	// Maps to ProgressBar default style
	public static final int DEFAULT = MaterialProgressDrawable.DEFAULT;

	private static final String LOG_TAG = RadarRefreshLayout.class.getSimpleName();
	...
	protected int getChildDrawingOrder(int childCount, int i) {
		Log.i(LOG_TAG, "childCount " + childCount + " i " + i + " mCircleViewIndex " + mCircleViewIndex);
	...
	protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
		...
		// mCurrentTargetOffsetTop = Math.abs(mCurrentTargetOffsetTop);
	...
	private void setTargetOffsetTopAndBottom(int offset, boolean requiresUpdate) {
		...
		mCurrentTargetOffsetTop = mCircleView.getTop();
		if(offset!=0)
		Log.i(LOG_TAG, "setOffset(" + offset + ") " + mTarget.getClass().getSimpleName());
