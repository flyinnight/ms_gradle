...
public class CustomRadioGroup extends LinearLayout {
    ...
    @Override
    protected CustomRadioGroup.LayoutParams generateDefaultLayoutParams() {
    ...
    private class CheckedStateTracker implements
            CheckableLinearLayout.OnCheckedChangeListener {
        public void onCheckedChanged(CheckableLinearLayout buttonView,
                                     boolean isChecked) {
    ...
    private class PassThroughHierarchyChangeListener implements
        ...
        public void onChildViewAdded(View parent, View child) {
            if (parent == CustomRadioGroup.this
                    && child instanceof CheckableLinearLayout) {
                int id = child.getId();
                ...
                ((CheckableLinearLayout) child).setOnCheckedChangeListener(mChildOnCheckedChangeListener);
//                try {
