...
public class StaticIpSet {
	...
	private String ipAddress = "192.168.2.100";
	private int preLength = 24;
	private String getWay = "192.168.2.103";
	private String dns1 = "192.168.2.103";
	...
	public void confingStaticIp(WifiConfiguration wifiConfig) {
		...
		if (android.os.Build.VERSION.SDK_INT < 11) {
			...
			Settings.System.putString(ctRes, Settings.System.WIFI_STATIC_DNS2,"192.168.2.103");
		}
